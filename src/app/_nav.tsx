            ...
            <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                <div className="flex items-center justify-between">
                    ...
                    <div className="hidden md:flex items-center gap-6">
                        {isAuth ? <Link href="/user/home" className="text-gray-700 hover:text-sky-600 font-medium transition-colors">
                            Home
                        </Link> : null}
                        <Link href="/blogs" className="text-gray-700 hover:text-sky-600 font-medium transition-colors">
                            Explore
                        </Link>
                        {isAuth ? null : <Link href="/auth/login" className="glass-button-secondary text-sm">
                            Sign In
                        </Link>}
                        {isAuth ? null : <Link href="/auth/register" className="glass-button-primary text-sm">
                            Get Started
                        </Link>}
                    </div>

                    {isAuth ? null : <div className="md:hidden flex items-center gap-2">
